  ...
  def main(args: Array[String]): Unit = {
    ...
    val clickStream = env
      .fromElements(
        ...
        UserClickLog("user_2", "2000", "click", "page_1"),  // (1400, 2000)
        UserClickLog("user_2", "1501", "click", "page_1") // (900, 1500)
      )
      .assignTimestampsAndWatermarks(
        new BoundedOutOfOrdernessTimestampExtractor[UserClickLog](Time.seconds(1)) {
          override def extractTimestamp(t: UserClickLog): Long = t.eventTime.toLong * 1000L
        }
      )
      .keyBy(_.userID)
    ...
    val browseStream = env
      .fromElements(
        UserBrowseLog("user_2", "4000", "browse", "product_1", "10"), // (1501, 2101)
      ...
      .assignTimestampsAndWatermarks(
        new BoundedOutOfOrdernessTimestampExtractor[UserBrowseLog](Time.seconds(1)) {
          override def extractTimestamp(t: UserBrowseLog): Long = t.eventTime.toLong *1000L
        }
      )
      .keyBy(_.userID)
